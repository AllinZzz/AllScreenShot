package com.allin.allscreenshot.manager;
...
public class ScreenShotManager {
    ...
    private static ScreenShotManager newInstance;
    ...
    public static ScreenShotManager newInstance(Context context) {
        ...
        if (newInstance == null) {
            synchronized (ScreenShotManager.class) {
                if (newInstance == null) {
                    newInstance = new ScreenShotManager(context);
                }
            }
        }
        return newInstance;
     ...
     * 设置截屏监听器
     */
    public ScreenShotManager setListener(OnScreenShotListener listener) {
        if (newInstance == null) {
            try {
